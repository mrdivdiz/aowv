...
public class AlexanderAi : EnemyAi
{
	// Token: 0x0600062D RID: 1581 RVA: 0x000158EC File Offset: 0x00013AEC
	public AlexanderAi(Game game)
	{
		this.game = game;
	}

	// Token: 0x0600062E RID: 1582 RVA: 0x000158FC File Offset: 0x00013AFC
	...
	// Token: 0x0600062F RID: 1583 RVA: 0x0001590C File Offset: 0x00013B0C
	public override void update()
	{
		this.tech_timer += 1f;
		this.specialTimer++;
		if (this.specialTimer > 2000 && this.techLevel == 2)
		{
	...
	// Token: 0x06000630 RID: 1584 RVA: 0x00016020 File Offset: 0x00014220
	private int getUOF()
	{
		int num = 0;
