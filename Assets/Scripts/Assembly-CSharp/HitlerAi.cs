...
public class HitlerAi : EnemyAi
{
	// Token: 0x0600063E RID: 1598 RVA: 0x00017824 File Offset: 0x00015A24
	public HitlerAi(Game game)
	{
		this.specialTimer = 0;
		this.game = game;
	}

	// Token: 0x0600063F RID: 1599 RVA: 0x0001783C File Offset: 0x00015A3C
	...
	// Token: 0x06000640 RID: 1600 RVA: 0x00017854 File Offset: 0x00015A54
	public override void update()
	{
		...
		{
			this.techLevel++;
			int num = Mathf.FloorToInt((float)(3 * this.unit_level + 1));
			num += (num - 1) * 3;
	...
	// Token: 0x06000641 RID: 1601 RVA: 0x00017FA0 File Offset: 0x000161A0
	private int getUOF()
	{
		int num = 0;
